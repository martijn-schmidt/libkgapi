...
/**
 * @headerfile FetchJob
 * @brief Abstract superclass for all jobs that fetch resources from Google or Microsoft
 *
...
class KGAPICORE_EXPORT FetchJob : public KGAPI2::Job
{
  ...
  protected:
     ...
     *
     * @param reply A QNetworkReply received from Google's or Microsoft's server
