...
#ifndef KGAPI2_ONEDRIVEFILEUNTRASHJOB_H
#define KGAPI2_ONEDRIVEFILEUNTRASHJOB_H
...
class KGAPIONEDRIVE_EXPORT FileUntrashJob : public KGAPI2::OneDrive::FileAbstractModifyJob
{
    Q_OBJECT
...
#endif // KGAPI2_ONEDRIVEFILEUNTRASHJOB_H
